...
|---|---:|---:|---|---|
| Ambari | 3.0.0 | 2.7.9 | 以 3.x 为长期管理面基线，2.7.9 仅作为兼容回退 | 已确认 |
| Ambari Metrics | 3.0.0 | TBD | 与 Ambari 3.0.0 同步验证 | 已确认 |
| Bigtop | 3.5.0 | 3.4.0 | 以 3.5.0 为构建体系基线，后续跟随 Bigtop stable release 升级 | 已确认 |
...
|---|---|---|---|---|---|---|---|---|
| Ambari | 3.0.0 | 2.7.9 | 必须验证 | 必须验证 | 评估 | 可选 | 是 | 传统大数据长期管理面 |
| Ambari Metrics | 3.0.0 | TBD | 必须验证 | 必须验证 | 评估 | 可选 | 是 | 与 Ambari 3.0.0 同步验证 |
| Bigtop | 3.5.0 | 3.4.0 | 必须验证 | 必须验证 | 评估 | 是 | 否 | 真实构建体系 |
| Hadoop | TBD | TBD | 必须验证 | 必须验证 | 评估 | 是 | 是 | HDFS / YARN |
| ZooKeeper | TBD | TBD | 必须验证 | 必须验证 | 评估 | 是 | 是 | HA 协调 |
